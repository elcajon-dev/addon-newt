...
please report it via [GitHub Security Advisories](https://github.com/homeassistant-apps/app-newt/security/advisories).
...
Please create a [new Security Advisory](https://github.com/homeassistant-apps/app-newt/security/advisories/new)
